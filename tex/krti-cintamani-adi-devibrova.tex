...
\footnotetext[1]{``\emph{nannu}'' works linguistically when repeating the phrase, but doesn't seem to connect back to ``\emph{d\=ev\=\i...}''. Ref 2 says ``\emph{n\=a talli}'' instead of ``\emph{nannu}''. ``\emph{n\=a talli}'' seems to be the correct one, meaning ``who can protect me like you, my mother''. (Kumar) }
